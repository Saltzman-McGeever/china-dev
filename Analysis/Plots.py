...
def create_average_project_size_map(df,
                                     amount_col='Amount_Constant_USD_2023',
                                     project_col='AidData_Record_ID',
                                     country_col='Country_of_Activity'):
    """
    Create a map showing average project size by country.
    ...
    country_stats.columns = ['Country', 'Total_Amount', 'Project_Count']
    country_stats['Avg_Project_Size_Millions'] = (country_stats['Total_Amount'] / country_stats['Project_Count']) / 1e6
    ...
    fig = px.choropleth(
        ...
        color='Avg_Project_Size_Millions',
        hover_name='Country',
        hover_data={
            'Avg_Project_Size_Millions': ':.2f',
            'Project_Count': True,
            'Country': False
        },
        color_continuous_scale='Purples',
        labels={'Avg_Project_Size_Millions': 'Avg Project Size (Millions USD)'}
    )
